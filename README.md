# MPI_CBS_scientific_staff_database

A database for keeping up with the skills of the scientific staff at the institut
...
```sh
git clone https://github.com/PTiringer/MPI_CBS_scientific_staff_database.git
cd MPI_CBS_scientific_staff_database
